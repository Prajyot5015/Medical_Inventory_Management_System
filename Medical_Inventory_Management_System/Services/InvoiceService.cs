            ...
            var document = Document.Create(container =>
            {
                container.Page(page =>
                {
                    ...
                    page.Content().Column(col =>
                    {
                        ...
                        col.Item().AlignLeft().Text($"Sale Date: {sale.SaleDate:dd-MM-yyyy}");
                        ...
                        col.Item().Table(table =>
                        {
                            ...
                            table.Cell().ColumnSpan(3).Padding(5).AlignRight().Text("Subtotal:").SemiBold();
                            table.Cell().Padding(5).Text($"₹{sale.TotalAmount:F2}").SemiBold().AlignRight();

                            table.Cell().ColumnSpan(3).Padding(5).AlignRight().Text("Discount:").SemiBold();
                            table.Cell().Padding(5).Text($"- ₹{sale.Discount:F2}").AlignRight();

                            table.Cell().ColumnSpan(3).Padding(5).AlignRight().Text("Grand Total:").FontSize(12).Bold();
                            table.Cell().Padding(5).Text($"₹{sale.GrandTotal:F2}").FontSize(12).Bold().AlignRight();
                        });
